...
export default function Created({ booking, setBooking, type }: ICardBookingStatus) {
    ...
    const handleAcceptBooking = async () => {
        ...
        try {
            const transaction = await writeContract('SmartStayBooking', 'approveBooking', [booking.id]);
    ...
    const handleRejectBooking = async () => {
        ...
        try {
            const transaction = await writeContract('SmartStayBooking', 'rejectBooking', [booking.id]);
            await transaction.wait();
