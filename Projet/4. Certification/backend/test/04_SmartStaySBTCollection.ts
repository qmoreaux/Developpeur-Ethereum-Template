...
describe('SmartStaySBTCollection contract', () => {
    ...
    const deploySmartStayFixture = async () => {
        ...
        return { _smartStaySBTCollection, _SmartStaySBTCollection, _owner, _addr1 };
    };

    describe('SBT Collection', async () => {
            ...
            it('Should attempt to mint a DID without being the owner and expect a revert', async () => {
                ...
                await expect(
                    smartStaySBTCollection
                        .connect(addr1)
                        .mint(addr1.address, SBTMetadataURI, duration, price, bookingID)
