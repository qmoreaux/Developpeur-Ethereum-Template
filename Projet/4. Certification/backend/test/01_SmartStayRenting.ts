...
describe('SmartStayRenting contract', () => {
    ...
    const deploySmartStayFixture = async () => {
        ...
        return { _SmartStayRenting, _smartStayRenting, _owner, _addr1 };
    };
    ...
    describe('Renting', async () => {
        describe('Create', async () => {
            ...
            it('Should attempt to create more than 5 rentings and expect a revert', async () => {
                ...
                await expect(smartStayRenting.createRenting(_renting)).to.be.revertedWith(
                    'SmartStay : Too many renting'
                );
            });
        });
        ...
        describe('Search', async () => {
            ...
            it('Should search with unitPrice and check the length', async () => {
                const rentings = await smartStayRenting.searchRenting(
